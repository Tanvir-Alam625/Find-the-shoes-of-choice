    ...
    return (
        <div id='main' className='main'>
            ...
            <div className="ask-answer">
                ...
                <hr />
                <p><b>Answer:</b>
                    React is an open source. His whole dome doesn't change him when the react works
                    There is change in his dome, only there change.
                    React compares the previous DOM to my DOM and if there is a change, he just updates the change and does not change anything else.

                </p>
                <h2>How usestate works?</h2>
                <hr />
                <p><b>Answer:</b>
                    React always focuses on the state. Any update on its state is actually rendered by the DOM to change its UI.
                    React always compares its UI with the current state from its previous state. If there is any update in the current state then it changes its UI immediately.
                </p>
            </div>
            </div>
            ...
            <div className="cart-container">
                <h3>Selected Clothes</h3>
                    {
                        cart.map(product=> <Cart data={product} key={product.id} remove={deleteItem}/>)
                    }
